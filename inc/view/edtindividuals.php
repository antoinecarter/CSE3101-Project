...
<?php if(isset($cred)){ 
  ...
  ?>
    ...
    <form method="post" action="">
        ...
        <div>
        <?php if($_SESSION['can_update'] == 1){ ?> <button type="submit" name="update_indv">Apply Changes</button> <?php } ?>
        <?php if($_SESSION['can_delete'] == 1){ ?>   <?php if($row['status'] != 'VERIFY'){ ?><a href="./Individuals/Registration/Delete?id="<?php echo $row['id']?>> <button style = "background-color:#eb0b4e;"  name="delete_indv"> Delete</button></a> <?php } ?> <?php } ?>
