<?php
    ...
    if(isset($_POST['update_units'])){
        $cred = $unitsModel->updateunits();
    }else if (isset($_POST['delete_units'])){
        $cred = $unitsModel->deleteunits();
    }
    $statement = $unitsModel->viewunits();
...
<div class = "edit-usr">
    ...
    <form method="post" action="">
        ...
        <div>
            ...
            <?php if($row['status'] != 'VERIFY'){ ?><a href="./Users/Registration/Delete?id="<?php echo $row['id']?>> <button style = "background-color:#eb0b4e;"  name="delete_units"> Delete</button></a> <?php } ?>
