<?php
    ...
    if(isset($_POST['update_sal'])){
        $cred = $salaryModel->updatesal();
    }else if (isset($_POST['delete_sal'])){
        $cred = $salaryModel->deletesal();
    }
...
<div class = "edit-usr">
    ...
    <form method="post" action="">
        ...
        <div>
            ...
            <?php if($row['status'] != 'VERIFY'){ ?><a href="./Users/Registration/Delete?id="<?php echo $row['id']?>> <button style = "background-color:#eb0b4e;"  name="delete_sal"> Delete</button></a> <?php } ?>
