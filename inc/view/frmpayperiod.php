...
if (isset($_POST['create_payp'])) {
    $cred = $payperiodsModel->createpayp();
}
?>
<div class = "form-usr">
<?php if(isset($cred)){ 
  ...
  ?>
    <form method="post" action="">
      ...
      <?php if($_SESSION['role']=='ADMIN'){ ?><button type="submit" name="create_payp">Create</button> <?php } ?>
      </p>
        </div>
        <?php } ?>
