  ...
  <?php if(isset($row['id'])){?>
    <form method="post" action="">
        ...
        <div style="height:100px;"></div>
           <div>
           <?php if($_SESSION['can_update'] == 1){ ?> <button type="submit" name="update_org_struct">Apply Changes</button> <?php } ?>
           <?php if($_SESSION['can_delete'] == 1){ ?>  <?php if($row['status'] != 'VERIFY'){ ?><a href="./Orgstructure/Registration/Delete?id="<?php echo $row['id']?>> <button style = "background-color:#eb0b4e;"  name="delete_org_struct"> Delete</button></a> <?php } ?> <?php } ?>
