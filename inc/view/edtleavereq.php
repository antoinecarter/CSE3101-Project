...
<div class = "edit-usr">
    ...
    <form method="post" action="">
        ...
        <?php } ?>
        <div>
                <button type="submit" name="update_leavreq">Apply Changes</button>
            <?php if($row['status'] != 'VERIFY'){ ?><a href="./Users/Registration/Delete?id="<?php echo $row['id']?>> <button style = "background-color:#eb0b4e;"  name="delete_leavreq"> Delete</button></a> <?php } ?>
