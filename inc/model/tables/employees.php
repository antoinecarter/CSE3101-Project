<?php
    ...
    class Employee implements crud {
        ...
        public function findEmp($org_id){
            $this->connection->query('SELECT a.id as id, b.ind_id  as ind_id,  CONCAT(b.surname, ", ", b.first_name, ":- ", c.pos_name, " (Emp No: ", a.emp_no, ")") as employee FROM employees a inner join individuals b on a.ind_id = b.id inner join positions c on a.position_id = c.id WHERE a.org_id = :org_id and a.status = "VERIFY"');
